...
public class MeshSimulatorService {
    ...
    private void seedDefaultDevices() {
        devices.put("phone-tanish",       new VirtualDevice("phone-tanish",       false));
        devices.put("phone-rahul",        new VirtualDevice("phone-rahul",        false));
        devices.put("phone-priya",        new VirtualDevice("phone-priya",        false));
        devices.put("phone-aman",         new VirtualDevice("phone-aman",         false));
        devices.put("phone-riya-bridge",  new VirtualDevice("phone-riya-bridge",  true));
    }
